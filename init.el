...
(custom-set-variables
 ...
 '(package-selected-packages
   '(company exec-path-from-shell po-mode sbt-mode lsp-metals lsp-treemacs magit-popup markdown-mode treemacs ess evil go-mode lsp-mode lsp-ui rust-mode scala-mode tuareg use-package utop web-mode yaml-mode magit ccls bazel-mode ace-window dockerfile-mode flymake gnu-elpa-keyring-update)))
(custom-set-faces
